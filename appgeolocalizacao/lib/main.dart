import 'dart:async';
  ...
  class _MapsState extends State<Maps> {
    ...
    final _initialPosition = const CameraPosition(
      target: LatLng(-20.2720728, -50.5510855),
      zoom: 15,
    );
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(title: const Text('Mapa Exemplo')),
        body: GoogleMap(
          //Posição inicial
          ...
          markers: {
            const Marker(
              ...
              position: LatLng(-20.2720728, -50.5510855),
 
              infoWindow: InfoWindow(
                title: 'Localização Desejada',
                snippet: 'Click no marker para ter a localização original!',
              ),
            ),
          },
        ),
